...
export declare namespace ConstraintValues {
    ...
    const toSize: (values: UserConstraintValues, parentSize: Size | AnimatableObject<Size> | null, autoSize: Size | null, freeSpace: WithFractionOfFreeSpace | null) => Size;
    const toRect: (values: UserConstraintValues, parentSizeInfo?: {
        sizing: Size | AnimatableObject<Size>;
        positioning: Size | AnimatableObject<Size>;
    } | null, autoSize?: Size | null, pixelAlign?: boolean, freeSpace?: WithFractionOfFreeSpace | null) => Rect;
}
/** @internal */
