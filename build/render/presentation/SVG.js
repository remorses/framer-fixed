...
export const SVGComponent = /* @__PURE__ */ (() => {
    return class SVGComponentInner extends Layer {
        ...
        render() {
            ...
            const { id, visible, style, fill, svg, intrinsicHeight, intrinsicWidth, ariaId = "", title, description, layoutId, className, variants, transition, withExternalLayout, innerRef, svgContentId, } = this.props;
            ...
            return (React.createElement(MotionComponent, { ...dataProps, layoutId: layoutId, transformTemplate: hasTransformTemplate ? transformTemplate(this.props.center) : undefined, id: id, ref: innerRef, style: outerStyle, className: className, variants: variants, transition: transition, tabIndex: this.props.tabIndex, role: title || description ? "img" : undefined, "aria-label": title, "aria-describedby": description ? ariaDescriptionId : undefined, ...{ href, target, rel, onClick } },
                content,
